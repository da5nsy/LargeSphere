...
R_SLIDER = 7;                     % slider assignments for R,G,B
G_SLIDER = 6;
B_SLIDER = 5;
...
for n = 1:8
 ...
 while ~BUTTON_PRESSED
  e = calllib('phidget21','CPhidgetInterfaceKit_getSensorValue',ikhandle,R__SLIDER,dataptr);
  rval = get(dataptr,'Value');
  e = calllib('phidget21','CPhidgetInterfaceKit_getSensorValue',ikhandle,G__SLIDER,dataptr);
  gval = get(dataptr,'Value');
  e = calllib('phidget21','CPhidgetInterfaceKit_getSensorValue',ikhandle,B__SLIDER,dataptr);
